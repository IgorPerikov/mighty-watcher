...
|`OUTPUT`     |Type of response output format (CONSOLE for console response, HTML for html-generated page, PDf for export of pdf report    |:heavy_multiplication_x:|console              |
